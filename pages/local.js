...
export default function Local(){
    ...
    async function recibeUserLog(){
        ...
        const data = await fetch('https://tattoomax-backend.onrender.com/users').then(res => res.json()).then(data => {setUserLog(data.find(user => user._id === userId))})
        return data;
    }
    ...
    const pedirCita = () => {
        ...
        fetch('https://tattoomax-backend.onrender.com/consultas/add', {method: 'POST', headers: {'Content-Type': 'application/json'}, body: JSON.stringify(datos)})
