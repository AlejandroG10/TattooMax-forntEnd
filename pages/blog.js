    ...
    <div>
      ...
      <div className={style.container}>
        <div>
          ...
          <p>Siempre has querido hacerte un tatuaje. Cuando llega el día y logras tenerlo, no todo ha terminado. Es necesario aprender cómo cuidar tu tattoo adecuadamente. Recuerda que desde ese instante necesitas un proceso delicado, higiénico y muy preciso sobre la piel.
          
          El objetivo es lograr que la zona tatuada cicatrice correctamente. Para ello hay que seguir unos rigurosos procesos. Esto hará que el tattoo se plasme en tu piel de manera rápida. Es por eso que hoy te enseñaremos a cómo cuidar tu tattoo una vez hecho.</p>
          
          <h2 className={style.h2}>CONSEJOS DE CÓMO CUIDAR TU TATTOO EN CASA</h2>
          <p>Cuando nos hacemos un tatuaje hay varios aspectos a considerar. Uno de ellos, y el más importante es ¡No tocarlo! Esto porque podría contaminar la zona provocando infecciones. 
          
          La otra es tratar de evitar que aparezcan costras. Esta es una función natural del cuerpo humano que trata de activar una vez detecta que la piel está sangrando. Sin embargo, si esto ocurre los pigmentos de color irán desapareciendo ya que están contenidos en las células.
          
          Para minimizar ambos eventos, lo ideal es usar algunas cremas. estos productos se venden especialmente para cuidar tu tattoo. Sirven para prevenir costras e incrementan el cuidado de la piel. Para mejorar esta situación les dejamos unos pasos de cómo cuidar tu tattoo adecuadamente en casa:</p>
          ...
          <p>Las cremas cicatrizantes son perfectas para agilizar este proceso. Si te has hecho un tatuaje y quieres que dure intacto hasta su recuperación, estas son algunas cremas que puedes utilizar:</p>
          ...
          <p>La mejor manera en cómo cuidar tu Tattoo es siendo precavido. Tener siempre las manos aseadas y manipular lo menos posible la zona tatuada. Usar cremas hidratantes y cicatrizantes, que aceleren el proceso.</p>
        </div><br/><br/><br/>

        <div>
          <Image src={imagenEspalda} className={style.imagen} alt="tatu espalda" width="600px" height="350px"/>

          <h1 className={style.h1}>SEGÚN ESTUDIO TENER TATUAJES ES BUENO PARA LA SALUD</h1>
          <p>¿Sabías que tener tatuajes es bueno para la salud? Actualmente existen estudios que confirman este posible beneficio a la salud, que hoy compartiremos contigo. 
          ...
          <p>Para muchos tener tatuajes es una forma de expresar rebeldía, un mensaje personal, recordar una fecha memorable o algún familiar. Sin embargo, detrás de esta cultura de hacerse tatuajes existen algunos mitos como – por ejemplo - que es dañino para salud.
          ...
          <p>El estudio se realizó a 24 mujeres y 5 hombres 829 en total), cuyas edades rondaban los 18 a 47 años de edad. Estos han sido voluntarios conformados por personas que se iban a tatuar por primera vez. También participaron personas con experiencia en tener tatuajes en el cuerpo. 
          ...
          <p>El estudio arrojó que la cantidad de inmunoglobulina A descendió a mayor escala en personas que se tatuaban por primera vez. Esto, comparado con los participantes cuyo proceso de tatuarse es recurrente.
          ...
          <p>Para el doctor Christopher Lynn, autor principal de la investigación. Además, es profesor asociado de Antropología en la Universidad de Alabama explica que: “solo es posible fortalecer el sistema inmune con tatuajes, si se han colocados en varias oportunidades”.
          ...
          <p>Al ser un tema tan delicado y polémico el de hacerse tatuajes, rápidamente este estudio cuenta con detractores. Una de ellas es la doctora Sylvie Stacy, especializada en Medicina Preventiva.
        ...
        <div>
          <Image src={imagenBrazo} className={style.imagen} alt="tatu brazo" width="600px" height="350px"/>

          <h1 className={style.h1}>HISTORIA DE LOS TATUAJES / CONOCE DE DÓNDE VIENEN</h1>
          <p>Los tatuajes parecen algo moderno, pero en realidad la historia de los tatuajes se remonta siglas atrás. En un estudio de tatuajes, la vibra que se respira es de creatividad, arte y mucha tinta.
          ...
          <p>La época neolítica, es el momento en donde los hallazgos más significativos y notorios se han hecho de los tatuajes. Se trata de una momia de un glaciar, ubicado en los Alpes entre Austria e Italia. Este cuerpo tenía pintura en su espalda y rodillas. Todo indicaba claramente que eran tatuajes.
          ...
          <p>Un tatuaje simboliza la modificación temporal o permanente, del color de la piel. Allí se sustituye el tono natural por un dibujo, figura o texto que es pintado sobre el cuerpo. Para ello, se emplean agujas que entran y salen muy rápidamente, esparciendo la tinta por debajo de la epidermis. 
          ...
          <p>La cultura de hacerse un tatuaje, es más buscada por los jóvenes. Ellos pueden tener diferentes motivos para pintar su cuerpo, pero sin importar cuál sea, lo fundamental es contar con un buen profesional que lo haga.
          ...
          <h2 className={style.h2}>CONCLUSIÓN</h2>
          <p>La historia de los tatuajes nos enseña que, las personas que se tatúan buscan plasmar algo en su cuerpo. Algo que los represente o los identifique. Si este es tu caso y quieres marcar algo en ti de gran relevancia, debes acudir con expertos. En especial, si será un tatuaje grande y en un área visible.</p>
        </div>
      </div>
      <div>
        <Footer/>
